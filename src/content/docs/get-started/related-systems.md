...
| **Perseus / Scaife URLs**                                                       | a passage on a specific reading platform                     | platform-bound passage | surface as `ResolverTarget` records with provenance so readers can jump from a stable reference to a useful platform |
